...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x00"); //20000
        ...
        checkpointData = {
            {
                { 0, uint256S("0x00000000103d1acbedc9bb8ff2af8cb98a751965e784b4e1f978f3d5544c6c3c")},
            }
        };
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("test1.nitonetwork.org.");
        vSeeds.emplace_back("test2.nitonode.com.");
